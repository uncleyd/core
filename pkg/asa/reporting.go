...
func (s *ReportingService) GetKeywordLevelwithinAnAdGroupReports(ctx context.Context, campaignID, adgroupId int64, params *ReportingRequest) (*ReportingResponseBody, *Response, error) {
